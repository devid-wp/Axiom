...
export const courses: Course[] = [
  {
    ...
    lessons: [
      L(
        ...
        ["Firmitas, Utilitas, Venustas", "Steel, Glass, Concrete", "Plan, Section, Elevation", "Form, Function, Ornament"],
        ["Firmitas, Utilitas, Venustas", "Сталь, Стекло, Бетон", "План, Разрез, Фасад", "Форма, Функция, Орнамент"],
        0
      ),
      L(
        ...
        { en: "The Modulor ties building dimensions to:", ru: "Модулор связывает размеры здания с:" },
        ["The Golden Ratio alone", "The human body", "The price of steel", "The cardinal directions"],
        ["Только с золотым сечением", "С телом человека", "С ценой стали", "Со сторонами света"],
        1
      ),
      L(
        ...
        { en: "Best daylight for a studio — steady and cool:", ru: "Лучший свет для студии — ровный и холодный:" },
        ["South, dramatic and warm", "West, changing every hour", "North, steady and cool", "No windows at all"],
        ["Южный, драматичный и тёплый", "Западный, меняется каждый час", "Северный, ровный и холодный", "Вообще без окон"],
        2
      ),
      L(
        ...
        { en: "A comfortable stair riser is about:", ru: "Удобный подступенок — это около:" },
        ["220 mm", "150–170 mm", "300 mm", "90 mm"],
        ["220 мм", "150–170 мм", "300 мм", "90 мм"],
        1
      ),
    ],
  },
  {
    ...
    lessons: [
      L(
        ...
        { en: "A complete load path must reach:", ru: "Полный путь нагрузки должен дойти до:" },
        ["The roof", "The tallest column", "The soil", "The facade"],
        ["Крыши", "Самой высокой колонны", "Грунта", "Фасада"],
        2
      ),
      L(
        ...
        { en: "Doubling the beam depth changes bending resistance by:", ru: "Удвоение высоты балки меняет сопротивление изгибу в:" },
        ["Nothing — only width matters", "Roughly 2×", "Roughly 8×", "Roughly 4×"],
        ["Никак — важна только ширина", "Примерно в 2 раза", "Примерно в 8 раз", "Примерно в 4 раза"],
        3
      ),
      L(
        ...
        { en: "An arch pushes outward at its base, so it needs:", ru: "Арка давит наружу у основания, поэтому ей нужны:" },
        ["Taller columns", "Abutments or ties to take the thrust", "More ornament", "A flat roof above"],
        ["Более высокие колонны", "Упоры или затяжки под распор", "Больше орнамента", "Плоская крыша сверху"],
        1
      ),
      L(
        ...
        { en: "The only inherently rigid polygon is the:", ru: "Единственный заведомо жёсткий многоугольник — это:" },
        ["Square", "Pentagon", "Triangle", "Hexagon"],
        ["Квадрат", "Пятиугольник", "Треугольник", "Шестиугольник"],
        2
      ),
    ],
  },
  {
    ...
    lessons: [
      L(
        ...
        { en: "Typical water/cement ratio by weight is:", ru: "Типичное водоцементное отношение по массе:" },
        ["1.5–2.0", "0.1–0.2", "Exactly 1.0", "0.4–0.6"],
        ["1,5–2,0", "0,1–0,2", "Ровно 1,0", "0,4–0,6"],
        3
      ),
      L(
        ...
        { en: "Unprotected steel loses strength fast near:", ru: "Незащищённая сталь быстро теряет прочность около:" },
        ["100 °C", "550 °C", "1500 °C", "0 °C"],
        ["100 °C", "550 °C", "1500 °C", "0 °C"],
        1
      ),
      L(
        ...
        { en: "Timber needs protection above what moisture content?", ru: "Выше какой влажности дерево нуждается в защите?" },
        ["5%", "50%", "20%", "95%"],
        ["5%", "50%", "20%", "95%"],
        2
      ),
  ...
  },
  {
    ...
    lessons: [
      L(
        ...
        { en: "The simplest order, used for temples of war gods:", ru: "Простейший ордер — для храмов богов войны:" },
        ["Corinthian", "Doric", "Ionic", "Composite"],
        ["Коринфский", "Дорический", "Ионический", "Композитный"],
        1
      ),
      L(
        ...
        ["F. L. Wright", "Mies van der Rohe", "Le Corbusier", "Louis Kahn"],
        ["Ф. Л. Райт", "Мис ван дер Роэ", "Ле Корбюзье", "Луис Кан"],
        2
      ),
      L(
        ...
        { en: "In parametric design, the design decisions live in the:", ru: "В параметрическом дизайне решения живут в:" },
        ["Hand sketch", "Scale model", "Material sample", "Parameters of the algorithm"],
        ["Ручном эскизе", "Макете", "Образце материала", "Параметрах алгоритма"],
        3
      ),
    ],
  },
